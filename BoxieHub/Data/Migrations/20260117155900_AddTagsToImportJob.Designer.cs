...
namespace BoxieHub.Data.Migrations
{
    ...
    [Migration("20260117155900_AddTagsToImportJob")]
    partial class AddTagsToImportJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoxieHub.Models.ImportJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<float?>("SourceDurationSeconds")
                        .HasColumnType("real");

                    b.Property<string>("SourceThumbnailUrl")
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");
            ...
            modelBuilder.Entity("BoxieHub.Models.PodcastEpisodeCache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SavedPodcastId")
                        .HasDatabaseName("IX_PodcastEpisodeCache_PodcastId");

                    b.HasIndex("SavedPodcastId", "EpisodeGuid")
                        .IsUnique()
                        .HasDatabaseName("IX_PodcastEpisodeCache_PodcastId_Guid");

                    b.ToTable("PodcastEpisodeCache");
                });

            modelBuilder.Entity("BoxieHub.Models.PodcastSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "SavedPodcastId")
                        .IsUnique()
            ...
            modelBuilder.Entity("BoxieHub.Models.SavedPodcast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BoxieHub.Models.TonieUploadJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SyncResultJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BoxieHub.Models.PodcastEpisodeCache", b =>
                {
                    ...
                    b.HasOne("BoxieHub.Models.SavedPodcast", "SavedPodcast")
                        .WithMany("Episodes")
                        .HasForeignKey("SavedPodcastId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
